...
3. Navega con las pestañas **Inicio**, **Productos** y **Admin**.

## Acceso al panel Admin

- PIN por defecto: **1234**.
- Solo el dueño debe ingresar al panel; los clientes usan Inicio/Productos.
- Configura:
  ...
  - Botón "Recargar catálogo automático" para cargar 100 productos de ejemplo.
...
- Pestaña de productos con búsqueda, filtros, ordenamiento y paginación para rendimiento.
